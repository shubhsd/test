...
const verticalScale = size => (height / guidelineBaseHeight) * size; //For margin top or margin bottom
// moderate scale is used for height and width
const moderateScale = (size, factor = 0.5) =>
  size + (scale(size) - size) * factor;

//moderateScaleVertical is used to give vertical margin eg: marginVertical : moderateScale(16)
